...
async function executeRemoteLaunchCommand(state, request) {
  ...
  if (!state.resolveRemoteCommandServices()) {
    return buildCommandResponse(request, false, {
      ...
      message: "The Dorblux renderer container is not ready yet.",
    })
  }
  ...
  if (!state.trainerService) {
    return buildCommandResponse(request, false, {
      ...
      message: "The Dorblux trainer service is not available yet.",
    })
  }
  ...
  if (!state.trainerLaunchRequestCtor) {
    return buildCommandResponse(request, false, {
      ...
      message:
        "The Dorblux trainer launch request constructor is not available yet.",
    })
  }
  ...
  if (!isRecord(launchInfo.app)) {
    return buildCommandResponse(request, false, {
      ...
      message: "Dorblux could not resolve a preferred installation for this game.",
    })
  }
  ...
  if (!trainerInfo) {
    return buildCommandResponse(request, false, {
      ...
      message: "Dorblux could not find a compatible trainer for this game.",
    })
  }
