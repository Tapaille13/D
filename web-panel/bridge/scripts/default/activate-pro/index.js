...
const GLOBAL_FLAG = "__dorbluxActivateProInstalled"
const SERVICE_PATCH_KEY = "__dorbluxGlirxProAccountServicePatched"
const ACCOUNT_SERVICE_METHODS = [
    "getUserAccount",
    "setAccountLanguage",
    "setAccountDorbluxBrandExperience",
]
const RETRY_DELAY_MS = 400
const MAX_ATTEMPTS = 90
const DEFAULT_SUBSCRIPTION = Object.freeze({ period: "yearly", state: "active" })

export function installActivatePro(DorbluxGlirx) {
...
function patchAccountService(state) {
    ...
    const ctor = findExportedConstructor(
        ...
        (prototype) =>
            ...
            typeof prototype.setAccountDorbluxBrandExperience === "function"
    )
    if (!ctor?.prototype) {
        return false
    }
